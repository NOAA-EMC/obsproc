...
####  export FORT77="timetwin.debug2.diags.t${cyc}"z""
      ...
      startmsg
      FORT_BUFFERED=TRUE $EXECobsproc/timetwin < cardec >>$pgmout 2> errfile
      export err=$?
####  $DATA/err_chk
...
#############################################################################
   ...
   $USHobsproc/mstr_shp_stn_lst_update.sh
