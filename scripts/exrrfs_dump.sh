...
echo "------------------------------------------------------------------------ "
echo "History: Nov 20 2025 - Original script generated by leveraging           "
echo "                       exrap_dump.sh from Obsproc v1.2.6.                "
...
#NAP=${NAP:-0} #Currently no slowdown to allow uprair to execute earlier.
