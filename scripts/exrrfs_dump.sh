...
# Dump group #11 (pb) = adpupa upair - adpupa
...
# NAP is introduced so that upair can run early on its own
...
sleep ${NAP} # to reverse 2min early start of jrrfs_dump in cron
export STATUS=NO
...
#       rrfs_p and -2.00 to +2.00 hours in rrfs and rrfs_e)
#
#========================================================================
...
#============================================================================
# Dump # 4 : MSONET -- TOTAL NUMBER OF SUBTYPES = 30
#             (30)   
#============================================================================
...
# Some reordering was done here based on recent sample runtimes.
   [ $DUMP_group11 = YES ]  &&  echo ./thread_11 >> $DATA/poe.cmdfile  # adpupa 1st
   [ $DUMP_group9 = YES ]  &&  echo ./thread_9 >> $DATA/poe.cmdfile  # lghtng
