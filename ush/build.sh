...
DB_BUFR_AVGDATA=${DB_BUFR_AVGDATA:-ON} #tip: DB_BUFR_AVGDATA=OFF ./ush/build.sh
DB_BUFR_DATACOUNT=${DB_BUFR_DATACOUNT:-ON}
DB_BUFR_LISTDUMPS=${DB_BUFR_LISTDUMPS:-ON}
DB_BUFR_PREPMODS=${DB_BUFR_PREPMODS:-ON}
DB_BUFR_REMOREST=${DB_BUFR_REMOREST:-ON}
DB_PREPOBS_PREPANOW=${DB_PREPOBS_PREPANOW:-ON}
...
# Build options per directory
CMAKE_OPTS+=" -DBUILD_BUFR_AVGDATA=$DB_BUFR_AVGDATA"
CMAKE_OPTS+=" -DBUILD_BUFR_DATACOUNT=$DB_BUFR_DATACOUNT"
CMAKE_OPTS+=" -DBUILD_BUFR_LISTDUMPS=$DB_BUFR_LISTDUMPS"
CMAKE_OPTS+=" -DBUILD_BUFR_PREPMODS=$DB_BUFR_PREPMODS"
CMAKE_OPTS+=" -DBUILD_BUFR_REMOREST=$DB_BUFR_REMOREST"
CMAKE_OPTS+=" -DBUILD_PREPOBS_PREPANOW=$DB_PREPOBS_PREPANOW"
